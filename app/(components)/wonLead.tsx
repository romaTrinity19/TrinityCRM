    ...
    <View style={styles.container}>
      <LinearGradient colors={["#5975D9", "#1F40B5"]} style={styles.header}>
        <View style={styles.headerContent}>
          ...
          <Text style={styles.headerTitle}>Won Lead</Text>
      ...
      >
        <Text style={{ color: "#000", fontSize: 18 }}>Won Lead</Text>
        ...
        renderItem={({ item, index }) => (
          <Card style={styles.card} mode="outlined">
            <Card.Title
              ...
              titleStyle={{ color: "#00695c" }}
              left={() => <IconButton icon="school" iconColor={"#00695c"} />}
            />
            ...
            <Card.Content>
              ...
              {item.email ? (
                <View style={styles.row}>
                  <IconButton icon="mail" size={18} iconColor="#00695c" />
              ...
              {item.date ? (
                <View style={styles.row}>
                  <IconButton icon="calendar" size={18} iconColor="#00695c" />
                  <Text>{item.date}</Text>
                </View>
              ) : null}
            </Card.Content>
...
export default withDrawer(WonLead, "WonLead");
