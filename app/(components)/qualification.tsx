...
function Qualification() {
  ...
  return (
    <View style={styles.container}>
      ...
      >
        <Text style={{ color: "#000", fontSize: 18 }}>Qualification</Text>
        ...
        renderItem={({ item, index }) => (
          <Card style={styles.card} mode="outlined">
            <Card.Title
              ...
              titleStyle={{ color: "#7D0C74" }}
              left={() => <IconButton icon="school" iconColor={"#7D0C74"} />}
            />
            ...
            <Card.Content>
              ...
              {item.email ? (
                <View style={styles.row}>
                  <IconButton icon="mail" size={18} iconColor="#7D0C74" />
              ...
              {item.date ? (
                <View style={styles.row}>
                  <IconButton icon="calendar" size={18} iconColor="#7D0C74" />
                  <Text>{item.date}</Text>
                </View>
              ) : null}
            </Card.Content>
...
export default withDrawer(Qualification, "qualification");
