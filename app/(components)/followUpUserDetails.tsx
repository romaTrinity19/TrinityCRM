  ...
  return (
    <ScrollView contentContainerStyle={styles.container}>
      <View style={styles.headerContainer}>
         <Ionicons name="arrow-back" size={26} color="#fff" style={styles.backIcon} onPress={()=>router.back()}/>
      ...
      <View style={styles.card}>
        ...
        <View style={styles.infoRow}>
          ...
          <Text style={styles.infoText}>04-09-2024</Text>

          <Ionicons name="time-outline" size={20} color="#4B65E9" style={{ marginLeft: 20 }} />
          <Text style={styles.infoText}>06:30 PM</Text>
        </View>

        {/* Service Type */}
        <View style={styles.infoRow}>
          <Ionicons name="briefcase-outline" size={20} color="#4B65E9" />
          <Text style={styles.infoText}>Mobile App Development</Text>
        </View>
