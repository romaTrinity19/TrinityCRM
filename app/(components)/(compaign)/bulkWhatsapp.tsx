...
const recipientsList = [
  { id: "1", name: "Chokoloko Website", phone: "1234567890" },
  { id: "2", name: "Mallika Dutta", phone: "1234567890" },
  { id: "3", name: "Harish", phone: "1234567890" },
  { id: "4", name: "Sudhanshu Francise", phone: "1234567890" },
  { id: "5", name: "Ram Jane", phone: "1234567890" },
  { id: "6", name: "Mridul Sir", phone: "1234567890" },
  { id: "7", name: "Trinity Solutions", phone: "1234567890" },
];
      ...
      <ScrollView showsVerticalScrollIndicator={false} style={styles.container}>
        ...
        <View style={styles.form}>
          <Text style={styles.label}>
           Or Enter Whatsapp No. Manually<Text style={{color:'red', fontSize:14}}>{' '} (Enter numbers one by one (Without +91))</Text>
          </Text>
          <TextInput
            style={styles.textarea}
            value={manualEmails}
            onChangeText={(text) => setManualEmails(text)}
            placeholder="e.g. 1234567890, 9807654321"
            multiline
            numberOfLines={4}
          />
        </View>
        ...
        <View style={styles.buttonContainer}>
          <TouchableOpacity onPress={handleSend} style={styles.sendBtn}>
            <Text style={styles.sendBtnText}>Send Bulk WhatsApp</Text>
          </TouchableOpacity>
